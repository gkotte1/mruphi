...
const icons = JSON.parse(fs.readFileSync('b6/icons.json', 'utf8'));
const OUT = 'c:/Users/krush/OneDrive/Desktop/m/murphi-clone/src/components/sites/murphi-ai-2e2619f3/shared/UtilityIcons.tsx';
...
// .feature-card-ico svg carries its 32px size as an inline style.
icons['download-app']['feature-card-ico'].forEach((x, i) => push('dl-' + i, x.svg, 32));
...
/**
 * Inline SVGs lifted verbatim from the /download-app/ markup. Generated —
 * re-run
 * docs/research/murphi-ai-2e2619f3/raw/gen-icons-b6.mjs rather than editing
