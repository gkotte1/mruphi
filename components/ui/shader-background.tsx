...
/* Murphi blues, fewer plasma lines than the source shader. */
const fsSource = `
  ...
  const vec4 lineColor = vec4(0.0, 0.494, 1.0, 1.0);
  ...
  const float warpFrequency = 0.45;
  const float warpAmplitude = 0.32;
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.059, 0.114, 0.329, 1.0);
    vec4 bgColor2 = vec4(0.02, 0.18, 0.42, 1.0);
    ...
    fragColor *= 0.82 + 0.18 * verticalFade;
    fragColor.a = 1.0;
    fragColor += lines * 1.35;
...
export default function ShaderBackground({
  ...
  useEffect(() => {
    ...
    const draw = (time: number) => {
      gl.clearColor(0.059, 0.114, 0.329, 1);
